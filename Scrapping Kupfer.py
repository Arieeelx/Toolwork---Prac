...
def scrap_kupfer(url, categoria_nombre):
    ...
    while True:
        ...
        print(f" {len(data)} productos scrapeados de {categoria_nombre}")
        print("=" * 70)
        ...
        try:
            ...
            print("=" * 70)
            print(f"{len(data)} Total productos scrapeados en {categoria_nombre} <- No existen más páginas para mostrar")
            break
